var jsKeyboard = {
    settings: {
        ...
        keyClass: "key", // default key class used to define style of text of
							// the button
        text: {
            close: "close"
        }
    },
    "keyboard": [], // different keyboards can be set to this variable in order
					// to switch between keyboards easily.
    ...
    currentKeyboard: "default", // it shows the which keyboard is used. If it's
								// not set default keyboard is used.
    currentElement: null,
    generateKeyboard: function(keyboard) {
        ...
        // s += "<div onclick=\"jsKeyboard.hide();\"><span>" +
		// jsKeyboard.settings.text.close + "</span><span class=\"closex\">
		// X</span></div>"
        s += "</div>";
    ...
    defaultKeyboard: {
        ...
        // 2nd row
                ...
                { value: "Enter", isChar: "false", buttonClass: "button button_enter", onclick: "jsKeyboard.enter();", keyClass: "key key_enter" },
        // 3rd row
                // { value: "ABC", isChar: "false", buttonClass: "button
				// button_capitalletterleft", onclick:
				// "jsKeyboard.changeToCapitalLetter()", keyClass: "key
                ...
                // { value: "ABC", isChar: "false", buttonClass: "button
				// button_capitalletterright", onclick:
				// "jsKeyboard.changeToCapitalLetter();", keyClass: "key
